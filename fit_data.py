    ...
    result : dictionary
        with keys:
            ...
            y_error : size (points, time)
                Original y errors data
             ''')
    parser.add_argument('X_coordinates', type=int, help='X_coordinates')
    parser.add_argument('Y_coordinates', type=int, help='Y_coordinates')
    parser.add_argument('kernel_method', type=str, default=RQ_Kernel, help='kernel_method, default=RQ_Kernel')

    args = parser.parse_args()

    # Call wrapper function
    fit_data(args.X_coordinates, args.Y_coordinates, arg.kernel_method)
