...
def main():
    #rho_pol_norm, electron_density = get_data(54527, 0, 0, 'imas_public', 'west', 'reflectometer_profile')
    #low density:
    #rho_pol_norm, electron_density = get_data(54719, 0, 0, 'imas_public', 'west', 'reflectometer_profile')
    #rho_pol_norm, electron_density = get_data(53949, 0, 0, 'imas_public', 'west', 'reflectometer_profile')
    
    rho_pol_norm, electron_density = get_data(54095, 0, 0, 'imas_public', 'west', 'ece')
